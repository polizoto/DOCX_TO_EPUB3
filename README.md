...
(See Title.txt in this repository for an example of a metadata block)
...
5. Use the bash script (DOCX_to_EPUB3.sh) to convert the DOCX files for each chapter into an EPUB 3 book
